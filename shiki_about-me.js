...
let data = {
  checked: [
    ...
    {genres: 'Детектив', ids: '46', censorship: '✓', num: 200}
  ],
  titles_details: {
    values: [(12018 + 200), 31359, 44654, 49400],
    titles: [
          ...
          [div=show-on-checked u-note]
            [quote=Virous]
              ...
              [list]
                ...
                [*]Совпадают категории и путь одной ссылки содержится в пути другой 
