...
let data = {
  checked: [
    ...
    {genres: 'Психологическое', ids: '67', censorship: '✓', num: 1}
  ],
  details: {
    values: [17684, 2350, 46, 20080],
    titles: [
      ...
      [div=CUSTOM_PANELS_CONTAINER]
        ...
        [div=CUSTOM_PANEL]
          [div=show-on-checked u-note]
            [quote=Virous]
              Из-за моей лени алгоритм подсчёта пока не учитывает некоторые моменты, поэтому эти числа немного, но отличаются от действительных
            [/quote]
          [/div]
